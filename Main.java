...
class Main {
    public static void main(String[] args) {
      ...
      System.out.println(sophocle.getCitationTragedie());
      System.out.println(aristophane.meilleurCat());
      System.out.println(euripide.meilleurCat());
      System.out.println(sophocle.meilleurCat());
